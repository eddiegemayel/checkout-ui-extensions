(() => {
  ...
  // extensions/admin-order-test/src/BlockExtension.jsx
  ...
  function App() {
    ...
    const [errorInfo, setErrorInfo] = (0, import_react13.useState)(null);
    const [error, setError] = (0, import_react13.useState)(false);
    const [lineItem, setLineItem] = (0, import_react13.useState)([]);
      ...
      function fetchData() {
        ...
        order(id: "${currentOrder}") {
          ...
          if (!result.errors && result.data.order) {
            result.data.order.lineItems.edges.map((lineItem2) => {
              let productId = lineItem2.node.product.id;
              function fetchProdData() {
                return __async(this, null, function* () {
                  const productResult = yield query(`query {
              product(id: "${productId}") {
                ...
                metafields(first: 10) {
                  ...
                  if (!productResult.errors && productResult.data) {
                    setLineItem((lineItem3) => [...lineItem3, productResult.data.product]);
                  } else {
    ...
    return (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AdminBlock2, { title: "Additional Order Details", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
        error == true && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "warning", children: "Error Recieved:" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { appearance: "warning", children: [
            '"',
            error == true && errorInfo.message,
            '"'
          ] })
        ] }),
        error == false && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { size: 3, children: "Product Metafields in this Order:" }),
          lineItem.map((product) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: "small base", padding: "base base large", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { size: 4, children: product.title }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
              product.metafields.edges.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: product.metafields.edges.map((metafield) => {
              ...
              product.metafields.edges.length == 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "No metafields present." })
            ] });
          })
        ] })
      ] }) })
...
//# sourceMappingURL=admin-order-test.js.map
