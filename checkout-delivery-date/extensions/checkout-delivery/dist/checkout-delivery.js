(() => {
  ...
  // extensions/checkout-delivery/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function getNextAvailableDate(disabledDateRanges) {
    const lastDisabledDate = disabledDateRanges.reduce(
      (maxDate, range) => {
  ...
  function Extension() {
    ...
    const [selectedDate, setSelectedDate] = (0, import_react15.useState)(initialSelectedDate);
    const [showDatePicker, setShowDatePicker] = (0, import_react15.useState)(false);
    const [hasShowDatePickerMetafield, setHasShowDatePickerMetafield] = (0, import_react15.useState)("false");
    ...
    (0, import_react15.useEffect)(() => {
      for (const cartLine of cartLines) {
        ...
        for (const metafieldEntry of appMetafields) {
          if (metafieldEntry.target.type == "product" && metafieldEntry.target.id == product.id && metafieldEntry.metafield.namespace == "checkout" && metafieldEntry.metafield.key == "show_shipping_date_picker" && metafieldEntry.metafield.value == "true") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      hasShowDatePickerMetafield == "true" && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", emphasis: "bold", children: "Want your order delivered on a certain date?" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Checkbox2,
          {
            ...
            children: "Select a target delivery date"
          }
        )
      ] }),
...
//# sourceMappingURL=checkout-delivery.js.map
